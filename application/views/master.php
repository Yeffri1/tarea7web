      ...
      <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarResponsive">
          ...
          <ul class="navbar-nav ml-auto">
           <li class="nav-item active">
               <a class="nav-link" href="<?php echo base_url('index.php?/Factura/'); ?>">Inicio</a>
            ...
            <li class="nav-item">
             ...
             <li class="nav-item">
               <a class="nav-link" href="<?php echo base_url('index.php?/Usuarios/salirUsuario'); ?>">Salir  
              </a>
            </li>
          </ul>
          <?php
        ...
        else
        {
          ?>
            <ul class="navbar-nav ml-auto">
            <li class="nav-item active">
               <a class="nav-link" href="<?php echo base_url('index.php?/Usuarios'); ?>">Login
                <span class="sr-only">(current)</span>
              </a>
            </li>
            <li class="nav-item">
               <a class="nav-link" href="<?php echo base_url('index.php?/Usuarios/registrarUsuario'); ?>">Registrarse</a>
